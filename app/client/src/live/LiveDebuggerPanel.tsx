...
function EventRow({ event, isSelected }: { event: DebugEvent; isSelected: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{
          flex: 1, color: '#94a3b8', fontFamily: 'monospace', fontSize: '11px',
          overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
        }}>
          {summary}
        </span>
        <span style={{ color: '#475569', fontSize: '10px' }}>{expanded ? '▼' : '▶'}</span>
      </div>
...
function StateInspector({ component }: { component: ComponentSnapshot }) {
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        {dbg.selectedComponent && (
          <div style={{
            ...
            <StateInspector component={dbg.selectedComponent} />
          </div>
        )}
      </div>
    </div>
